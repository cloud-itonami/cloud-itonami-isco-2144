(ns mechanical-engineering.store
  "SSoT for the ISCO-08 2144 independent mechanical-engineering sole-
  proprietor actor. Store is a protocol injected into the
  `mechanical-engineering.actor` StateGraph — `MemStore` is the
  ...
  Domain:
    ...
    project  — a registered engineering project (:project-id, :name)
    record   — a committed operating record under a project (design
               note, review, load-bearing design sign-off,
               pressure-vessel safety certification) — written ONLY
